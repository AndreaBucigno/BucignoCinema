...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand fw-bold fs-5" href="/BucignoCinema/index.php">
            ...
            <div class="collapse navbar-collapse" id="navbarUser">
                <ul class="navbar-nav ms-auto gap-1">
                    <li class="nav-item">
                        <a class="nav-link {{active_profilo}}" href="/BucignoCinema/Sub_User/profilo.php">
                            <i class="bi bi-person-circle me-1"></i>Profilo
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{active_prenotazioni}}" href="/BucignoCinema/Sub_User/prenotazioni.php">
